...
class ResNet50UpProj(Network):
    def setup(self):
        ...
        # .conv(7, 7, 64, 2, 2, relu=False, name='conv1')
        .conv(1, 1, 2048, 1, 1, relu=False, name='conv0')
        .conv(7, 7, 256, 2, 2, relu=False, name='conv1')
        .batch_normalization(relu=True, name='bn_conv1')
        # .max_pool(3, 3, 2, 2, name='pool1')
        .conv(3, 3, 256, 2, 2, biased=False, relu=False, name='res2a_branch1')
        .batch_normalization(name='bn2a_branch1'))
        ...
        (self.feed('res5b_relu',
         ...
         .up_project([3, 3, 1024, 512], l_id='2x', stride=1, BN=True)
